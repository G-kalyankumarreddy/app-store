...
class AppStore extends Component {
  ...
  displayAppsList = () => {
    ...
    const filterAppsList = appsList.filter(
      eachApp => eachApp.category === activeTab,
    )
    return filterAppsList
  }

  onChangeDisplayApps = event => {
  ...
  render() {
    ...
    const filteredApps = this.displayAppsList()
    const appsDisplayBasedOnSearch = filteredApps.filter(eachApp =>
      ...
      <div className="app-container">
        ...
        <div className="search-container">
          <input
            ...
            className="search"
            value={searchInput}
            onChange={this.onChangeDisplayApps}
          />
          <img
        ...
        <ul className="apps-list-container">
          {appsDisplayBasedOnSearch.map(eachApp => (
